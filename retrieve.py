...
def run_retrieve(
    ...
    query_text: str = query or os.getenv(
        "QUERY_TEXT",
    ...
    model: SentenceTransformer = get_embedding_model(config)
    ...
    results = rerank_chunks(query_text, results, config, top_k=RERANK_TOP_K)
